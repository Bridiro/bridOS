...
- First of all I'm using [my font library](https://github.com/Bridiro/sw-lib-font), which for now is limited by memory
- I want to reach the same point as the CLI one before moving on
- I want to add a mouse support
- It would be a good idea to implement a basic filesystem (from scratch is the idea, copied is the way)
